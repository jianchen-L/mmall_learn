...
public class UserServiceImpl implements IUserService {
    ...
    public ServerResponse<String> selectQuestion(String username) {
        ...
        return ServerResponse.createByErrorMessage("The password recovery question is empty");
    }
    ...
    public ServerResponse<String> checkAnswer(String username, String question, String answer) {
        ...
        return ServerResponse.createByErrorMessage("The answer to the question is wrong");
    }

    public ServerResponse<String> forgetResetPassword(String username, String passwordNew, String forgetToken) {
        if (StringUtils.isBlank(forgetToken)) {
            return ServerResponse.createByErrorMessage("Parameter error, token needs to be passed");
        }
        ...
        if (StringUtils.equals(forgetToken, token)) {
            ...
            if (rowCount > 0) {
                return ServerResponse.createBySuccessMessage("Successfully change password");
            }
        }
        else {
            return ServerResponse.createByErrorMessage("Token error, please re-acquire the token for resetting the password ");
        }
    ...
    public ServerResponse<String> resetPassword(String passwordOld, String passwordNew, User user) {
        ...
        if (updateCount > 0) {
            return ServerResponse.createBySuccess("Password updated successfully");
        }
    ...
    public ServerResponse<User> updateInformation(User user) {
        ...
        if (resultCount > 0) {
            return ServerResponse.createByErrorMessage("The email already exists, please change the email and try to update again");
        }
        ...
        if (updateCount > 0) {
            return ServerResponse.createBySuccess("Successfully updated personal information", updateUser);
        }
