...
public class OrderController {
    ...
    public ServerResponse pay(HttpSession session, Long orderNo, HttpServletRequest request) {
        ...
        if (user == null) {
            return ServerResponse.createByErrorCodeMessage(ResponsCode.NEED_LOGIN.getCode(), ResponsCode.NEED_LOGIN.getDesc());
        }
    ...
    public Object alipayCallback(HttpServletRequest request) {
        ...
        try {
            ...
            logger.error("Alipay verification callback exception", e);
        }
